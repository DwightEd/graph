"""P7: budgeted reasoning audit, then unchanged localized grounding; no GT input."""
import argparse
import hashlib
import json
import re
...
def main():
    ...
    if args.phase == 'validation':
        raise ValueError('P7 requires a NEW frozen confirmation; neither old R04 nor P6 confirmation may be reused')
