...
from next_iteration.grounded_graph_feature_runner import read, verify
...
PROTOCOL = {"schema": "grounded-graph-ragtruth-evaluation@1", "labels_stage": "evaluation only after frozen predictions",
    ...
    "scope": "natural detection ranking; not semantic-owner or native-route accuracy"}
