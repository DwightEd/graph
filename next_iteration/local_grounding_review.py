"""P6: frozen full-answer evidence audit then localized word grounding; no GT input."""
import argparse
import hashlib
import json
import re
...
def main():
    ...
    if args.phase == 'validation':
        raise ValueError('P6 needs a new frozen confirmation roster; original R04 validation cannot be reused')
