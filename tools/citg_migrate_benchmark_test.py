...
path = Path("tests/test_conditioned_benchmark.py")
...
start = text.index("def _write_cmrp_scores(")
end = text.index("\n\ndef _evaluated", start)
helper = '''def _write_cmrp_scores(path: Path, dataset: ResearchDataset):
