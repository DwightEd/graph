"""Command-line entrypoint for HoloRoute."""
...
from .experiment import score_split, train_reference


def parser() -> argparse.ArgumentParser:
    root = argparse.ArgumentParser(description="HoloRoute attention-event graph model")
