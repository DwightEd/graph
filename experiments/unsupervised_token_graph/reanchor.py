"""Label-free local-to-remote reanchor and information diagnostics.
...
or answer-region assumptions are used. FAI and the full-response event quantile
are retrospective diagnostics, not prefix-causal inference.
"""
...
class ReanchorAnalyzer:
    ...
    def run(self, attention, prompt_length):
        ...
        return ReanchorResult(waad, fai, local, remote, prompt_mass, evidence_entropy,
