...
随后用户已返回 v2 输入的新读出指标：完整 `.866748/.341315`、去图 `.881694/.367112`、
去anchor `.788161/.241588`、去连续性 `.833162/.317014`、去token来源 `.863069/.431527`、
随机图 `.872962/.343077`。这是用户提供的实测JSON，图正则仍无收益；
最新全量验证主线见 [RAGTRUTH_SOURCE_FIRST.md](RAGTRUTH_SOURCE_FIRST.md)。
