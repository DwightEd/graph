...
REF="${3:-$BASE/research/graph/outputs/p1_prefix_development_20260913_v1}"
exec "$BASE/conda_envs/research/bin/python" -m next_iteration.risk_transport \
  --inputs "$BASE/research/reanchor/outputs/r04_roster_20260913_v1/inputs.jsonl" \
  --model "$BASE/models/Meta-Llama-3.1-8B-Instruct" --reference-predictions "$REF" \
